...
class _ToggleState extends State<Toggle> {
  ...
  static Color colorGreen = Colors.green.shade900;
//Color(0xff46E387)
  void _handleTap(bool newState) {
    setState(() {
      globals.show_attractions.value = !globals.show_attractions.value;
    });
  }
  ...
  Widget build(BuildContext context) {
    return ValueListenableBuilder(
        ...
        builder: (BuildContext context, bool value, Widget? child) {
          return _styledInnerCircle(toggleState: value)
          .parent(({required Widget child}) =>
          _styledOuterCircle(child: child, toggleState: value))
          .parent(({required Widget child}) => _styledBox(
          child: child, tapState: onTapState, toggleState: value))
